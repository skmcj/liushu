...
public class TLSSigUtil {
    ...
    @Value("${liushu.tim.SDKAPPID}")
    public void setSDKAPPID(long SDKAPPID) {
        TLSSigUtil.SDKAPPID = SDKAPPID;
    }

    @Value("${liushu.tim.SECRETKEY}")
    public void setKEY(String KEY) {
        TLSSigUtil.KEY = KEY;
    }

    @Value("${liushu.tim.EXPIRETIME}")
    public void setEXPIRETIME(long EXPIRETIME) {
        TLSSigUtil.EXPIRETIME = EXPIRETIME;
    }
    ...
    private static String genUserSig(String userid, long expire, byte[] userbuf) {
        ...
        compressor.end();
        return (new String(CommonUtil.base64EncodeUrl(Arrays.copyOfRange(compressedBytes,
